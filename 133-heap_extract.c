...
/**
 * Function _preorder traverses a binary tree using pre-order traversal.
 *
 * @param tree Pointer to the root node of the tree to be traversed.
 * @param node The last node in the traversal.
